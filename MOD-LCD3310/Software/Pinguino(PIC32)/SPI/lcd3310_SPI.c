...
unsigned char Dummy;
	...
	#define LCD_RES_MAKE_OUT()      pinMode (LCD3310_RES_DNUM, OUTPUT)
	#define LCD_RES_HIGH()          digitalWrite (LCD3310_RES_DNUM, 1)
	#define LCD_RES_LOW()           digitalWrite (LCD3310_RES_DNUM, 0)
