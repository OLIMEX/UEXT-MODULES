...
#else
	#define LCD_MOSI_MAKE_OUT()     TRISG = TRISG & (~LCD3310_MOSI_MASK)
	#define LCD_MOSI_HIGH()         LCD3310_MOSI_PORT = LCD3310_MOSI_PORT | LCD3310_MOSI_MASK
	#define LCD_MOSI_LOW()          LCD3310_MOSI_PORT = LCD3310_MOSI_PORT & (~LCD3310_MOSI_MASK)

	#define LCD_SCK_MAKE_OUT()      TRISG = TRISG & (~LCD3310_SCK_MASK)
	#define LCD_SCK_HIGH()          LCD3310_SCK_PORT = LCD3310_SCK_PORT | LCD3310_SCK_MASK
	#define LCD_SCK_LOW()           LCD3310_SCK_PORT = LCD3310_SCK_PORT & (~LCD3310_SCK_MASK)

	#define	LCD_CS_MAKE_OUT()		TRISF = TRISF & (~LCD3310_CS_MASK)
	#define LCD_CS_HIGH()           LCD3310_CS_PORT = LCD3310_CS_PORT | LCD3310_CS_MASK
	#define LCD_CS_LOW()            LCD3310_CS_PORT = LCD3310_CS_PORT & (~LCD3310_CS_MASK)

	#define LCD_RES_MAKE_OUT()      TRISD = TRISD & (~LCD3310_RES_MASK)
	#define LCD_RES_HIGH()          LCD3310_RES_PORT = LCD3310_RES_PORT | LCD3310_RES_MASK
	#define LCD_RES_LOW()           LCD3310_RES_PORT = LCD3310_RES_PORT & (~LCD3310_RES_MASK)

	#define LCD_CD_MAKE_OUT()       TRISD = TRISD & (~LCD3310_CD_MASK)
	#define LCD_CD_HIGH()           LCD3310_CD_PORT = LCD3310_CD_PORT | LCD3310_CD_MASK
	#define LCD_CD_LOW()            LCD3310_CD_PORT = LCD3310_CD_PORT & (~LCD3310_CD_MASK)
#endif
